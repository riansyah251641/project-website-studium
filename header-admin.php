        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="float: left;">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="tampilantutor.php">HOME</a>
              </li>
              <li class="nav-item dropdown" style="margin-left:500px;">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="./pembayaran.php">Studium Learn</a></li>
                  <li><a class="dropdown-item" href="./beasiswa/lihatdata-donasi.php">Studium Scholarship</a></li>
                  <li><a class="dropdown-item" href="./studium-book-admin.php">Studium Bookcase</a></li>
                  <li>
                  <li><a class="dropdown-item" href="./lihatcoment.php">Komentar</a></li>
