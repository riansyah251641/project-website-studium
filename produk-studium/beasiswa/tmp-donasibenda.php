...
if (isset($_POST['submit'])) {
    ...
    $rian1 = "INSERT INTO validasibeasiswa(kategori,jenis,nama,nomor,nominal,jenisbenda,keterangan,bukti) values('$kategori','$jenis','$nama' , '$nomor' , '$nominal','$benda' , '$keterangan' , '$bukti' )";
...
<head>
    ...
    <div class="totaldonasi">
        ...
        <h4 class="value1">Total Donasi Peduli Sekolah</h4>
    ...
    <form method="POST" action="" enctype="multipart/form-data">
        ...
        <select name="kategori" id="kategori" style="width:300px ; height: 30px;" required>
            <option value="Peduli Sekolah">Peduli Sekolah</option>
        </select>
        <label for="kategori">Jenis :</label>
        <select name="jenis" id="Jenis" style="width:300px ; height: 30px;" required>
        ...
        <label for="nominal">Jenis benda : </label>
        <input type="text" name="benda" placeholder="Jika tidak benda isi ( - )" id="nominal" required> <br>
        ...
        <p style="color:red; font-size:15px ;margin-bottom:-10px;">*Jika berupa barang silahkan kirim ke alamat studium ,lalu silahkan anda foto bukti pengirimannya</p>
