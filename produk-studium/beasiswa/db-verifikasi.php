...
<head>
    ...
    <div class="ikon">
        <a href="./db-dashboard.php" class="tbl-home" style="font-size: 30px;">
            back to awal
        </a>
        <h1>.</h1>
        <h1 style="color:#3AF2B2; font-size:35px ;font-weight:600;">Verifikasi Data Scholarship</h1>
        <a class="tombol" href="./.php">peduli bersama</a>
