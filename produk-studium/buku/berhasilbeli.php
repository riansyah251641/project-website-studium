...
<head>
    ...
    <?= include("buku.php") ?>
    <div class="wrapper">
        <h1>Selamat buku Anda telah berhasil membeli buku </h1>
        <h4>selanjutnya buku Anda akan kami verifikasi terlebih dahulu !!</h4>
        <h4>Jika memenuhi syarat , maka kami akan menghubungi anda dan buku segera dikirim.</h4>
        ...
        <h5>Untuk Verifikasi buku silahkan masuk ke data admin</h5>
        <a class="tbl-cek" href="./verifikasibeli.php">Verifikasi data</a>
    </div>
